...
**Satu bar melayang di tengah-atas layar yang menampilkan status semua sesi AI coding agent-mu â€” dan membiarkanmu menjawabnya tanpa mencari-cari terminal.**
...
### **[Vibe-Bars-Setup.exe](https://github.com/Helveticxa/vibe-bars-exe/raw/main/Vibe-Bars-Setup.exe)** â€” 3,35 MB
...
## âš ï¸ Windows akan menampilkan peringatan â€” ini yang terjadi dan kenapa
...
Untuk melanjutkan: klik **More info** â†’ **Run anyway**.
...
Yang bisa saya berikan sebagai gantinya adalah **checksum SHA-256 di atas** â€” cocokkan,
...
otomatis â€” nama proyek, apa yang sedang dikerjakan agent detik ini, model, git branch,
token, jumlah berkas tersentuh, diff `+/âˆ’`, subagent, dan MCP server yang terpakai.
...
**Lompat ke terminalnya.** Satu klik, jendela terminal sesi itu naik ke depan â€” bahkan
...
Kuota Claude Code 5 jam dan 7 hari tersedia sebagai opsi (default mati â€” lihat Privasi).
...
**Ringan saat diam.** Sekitar 0,5â€“1,2% dari satu core saat menganggur, dan proses
intinya memakai 26 MB.

---

## Privasi â€” singkat, dan bisa diperiksa
...
- **Satu-satunya fitur yang memakai jaringan** adalah kuota Claude Code, dan itu
  **default mati**. Kalau kamu menyalakannya, ia memanggil endpoint resmi Anthropic
  memakai token yang sudah dipakai Claude Code sendiri â€” tujuan yang sama yang sudah
...
3. Kalau kamu memakai Claude Code, tekan **Pasang hook & mulai**. Ini menambahkan tiga
   ...
   bukan menimpa â€” hook milik alat lain tidak pernah disentuh, urutan kunci JSON
   ...
   Kalau Vibe Bars mati atau ditutup, Claude Code **tidak ikut macet** â€” hook-nya
   fail-open dan CLI lanjut seperti biasa.

4. Arahkan kursor ke bar untuk membuka panel. Tidak perlu klik.

**Mencopot:** lewat Settings â†’ Apps di Windows seperti aplikasi biasa. Hook otomatis
...
## Yang belum bisa â€” dikatakan di depan
...
- **Kolom biaya menampilkan `â€”`** sampai kamu mengisi tabel harga di
...
| WebView2 | Sudah dibundel di installer â€” dipasang otomatis kalau belum ada |
