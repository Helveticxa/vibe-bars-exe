...
### **[Vibe-Bars-Setup.exe](https://github.com/Helveticxa/vibe-bars-exe/raw/main/Vibe-Bars-Setup.exe)** — 3,35 MB

Klik, jalankan, selesai. Pemasangan per-pengguna, **tidak perlu hak administrator**.

```
SHA-256  3253F19857AC72589F1EFB079F446DF1962972DD164E6E20AEBA759688643C21
Versi    0.1.0
```
...
## ⚠️ Windows akan menampilkan peringatan — ini yang terjadi dan kenapa
...
**Mencopot:** lewat Settings → Apps di Windows seperti aplikasi biasa. Hook otomatis
...
- **Kolom biaya menampilkan `—`** sampai kamu mengisi tabel harga di
